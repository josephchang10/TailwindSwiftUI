...
public struct TopRightBottomLeft {
    public enum Scale {
...
public extension View {
    func top(_ scale: TopRightBottomLeft.Scale) -> some View {
        GeometryReader { geometry in
            frame(width: geometry.size.width, height: geometry.size.height - .rem(scale.size))
        }
        .offset(y: .rem(scale.size))
    }
    
    func right(_ scale: TopRightBottomLeft.Scale) -> some View {
        GeometryReader { geometry in
            frame(width: geometry.size.width - .rem(scale.size), height: geometry.size.height)
        }
    }
